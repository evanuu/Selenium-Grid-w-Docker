...
//        System.out.println("Test Name --> " + result.getName() + " --> Successful");
        ExtentFactory.getInstance().getExtent().log(Status.PASS, "Test: " + result.getMethod().getMethodName() + " Passed");
...
//        System.out.println("Test Name --> " + result.getName() + " --> Failed");
        ExtentFactory.getInstance().getExtent().log(Status.FAIL, "Test: " + result.getMethod().getMethodName() + " Failed");
...
//        System.out.println("Test Name --> " + result.getName() + " --> Skipped");
        ExtentFactory.getInstance().getExtent().log(Status.SKIP, "Test: " + result.getMethod().getMethodName() + " Skipped");
        ExtentFactory.getInstance().removeExtentObject();
    }
